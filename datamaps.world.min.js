            ...
            geographyConfig: {
                ...
                popupTemplate: function(a, b) {
                    function findState(element) {
                        return element == a.properties.name;
                    }

                    var isSelected = beenTo.findIndex(findState);
                    if(isSelected == -1) {
                        
                        if(curstate != a.properties.name.toString()) {
                            generate(a.properties.name.toString());
                            curstate = a.properties.name.toString();
                        } 
                        return '<div class="hoverinfo"><strong>' + a.properties.name + ": Pack your bags!" + "</br>" + document.getElementById("image0").innerHTML + "</strong></div>"
                    } else {
                        return '<div class="hoverinfo"><strong>' + a.properties.name + ": You've visited here!" + "</strong></div>"
                    }
                },
                popupOnHover: !0,
                highlightOnHover: !0,
